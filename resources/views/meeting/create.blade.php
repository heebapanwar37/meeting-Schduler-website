...
@section('content')
    <div class="container-fluid meeting">
        ...
        <div class="btn-container mb-2">
            <a href="{{url('meeting/create/online')}}" class="btn-2">Online</a>
            <a href="{{url('meeting/create')}}" class="btn-1">Offline</a>
        </div>
        <form method="post" action="{{url('meeting/create')}}" enctype="multipart/form-data">
            @csrf
